...
import com.ngoding.githubuserapp.activity.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        showDailyNotification(context, context.getResources().getString(R.string.app_name),
                context.getString(R.string.daily_reminder_message), NOTIFICATION_ID);
    }

    private void showDailyNotification(Context context, String title, String message, int notification_id) {
        ...
        Objects.requireNonNull(notificationManagerCompat).notify(notification_id, builder.build());
    }
